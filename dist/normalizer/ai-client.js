...
export async function normalizeRequest(provider, model, original) {
    const body = original;
...
async function normalizeWithOpenAI(model, original) {
...
async function normalizeWithAnthropic(model, original) {
...
function normalizeLocal(original) {
    const body = original;
...
function inferServer(identifier) {
