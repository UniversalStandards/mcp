...
export async function searchGitHubRegistry(query: SearchQuery): Promise<RegistryServer[]> {
...
async function searchMcpRun(query: SearchQuery): Promise<RegistryServer[]> {
  try {
...
async function searchGitHubRepos(query: SearchQuery): Promise<RegistryServer[]> {
...
async function searchKnownOrgs(query: SearchQuery): Promise<RegistryServer[]> {
  const knownOrgs = [
...
function matchesQuery(item: any, query: SearchQuery): boolean {
...
function extractNpmPackage(repoName: string): string {
...
function extractCapabilities(description: string, name: string): string[] {
